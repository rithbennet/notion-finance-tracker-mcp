/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 5f64fd33cbc94e3d4c4a7fa106c1632d)
// Runtime types generated with workerd@1.20260601.1 2026-06-03 nodejs_compat
interface __BaseEnv_Env {
	NOTION_API_KEY: string;
	NOTION_EXPENSES_DATA_SOURCE_ID: string;
	NOTION_BUDGET_DATA_SOURCE_ID: string;
	NOTION_INCOMES_DATA_SOURCE_ID: string;
	NOTION_ACCOUNTS_DATA_SOURCE_ID: string;
	NOTION_TRANSFERS_DATA_SOURCE_ID: string;
	NOTION_SUBSCRIPTIONS_DATA_SOURCE_ID: string;
	NOTION_GOALS_DATA_SOURCE_ID: string;
	NOTION_MONTHS_DATA_SOURCE_ID: string;
	FINANCE_MCP_AUDIT_LOG: string;
	NOTION_EXPENSES_DATABASE_ID: string;
	NOTION_INCOMES_DATABASE_ID: string;
	NOTION_TRANSFERS_DATABASE_ID: string;
	FINANCE_MCP_BEARER_TOKEN: string;
	FinanceMCP: DurableObjectNamespace<import("./src/worker").FinanceMCP>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker");
		durableNamespaces: "FinanceMCP";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NOTION_API_KEY" | "NOTION_EXPENSES_DATA_SOURCE_ID" | "NOTION_BUDGET_DATA_SOURCE_ID" | "NOTION_INCOMES_DATA_SOURCE_ID" | "NOTION_ACCOUNTS_DATA_SOURCE_ID" | "NOTION_TRANSFERS_DATA_SOURCE_ID" | "NOTION_SUBSCRIPTIONS_DATA_SOURCE_ID" | "NOTION_GOALS_DATA_SOURCE_ID" | "NOTION_MONTHS_DATA_SOURCE_ID" | "FINANCE_MCP_AUDIT_LOG" | "NOTION_EXPENSES_DATABASE_ID" | "NOTION_INCOMES_DATABASE_ID" | "NOTION_TRANSFERS_DATABASE_ID" | "FINANCE_MCP_BEARER_TOKEN">> {}
}
